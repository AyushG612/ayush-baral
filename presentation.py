...
t.goto(0, 50)
t.pendown()
t.write(" By Ayush", font=('arial', 20, 'bold'), align="center")
t.penup()


turtle.addshape("ravens.gif")
t.penup()
t3.shape("ravens.gif")
a = t3.stamp()
t3.goto(0,0)
...
t.write( "cheeseburgers and fries are my favorites!", font=('lora', 20, 'bold'), align="center")
t.goto(100,-100)
t.pencolor('red')
t.fillcolor('blue')
t.begin_fill()
...
t.clearstamps()
turtle.addshape("cheese burger .gif")
t3.goto(-275,200)
t3.shape("mc chiken (2).gif")
a = t3.stamp()
t3.goto(-200,0)
turtle.addshape("cheese burger .gif")
t3.goto(275,200)
t3.shape("cheese burger .gif")
a = t3.stamp()
t3.goto(200,0)
